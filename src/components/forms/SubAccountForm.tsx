...
import { saveActivity, upsertSubAccount } from '@/lib/queries'
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      await saveActivity({
        ...
        desc: `${userName} | updated sub account | ${response.name}`,
        subAccId: response.id,
      })

      ToastNotify({
        title: 'Success',
        msg: 'Successfully saved your subaccount details.',
      })
      ...
      ToastNotify({
        title: 'Oppse',
        msg: 'Could not save sub account details.',
      })
    }
  }
