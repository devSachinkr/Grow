...
import { ClipboardIcon, Contact2, ShoppingCart } from "lucide-react";
...
import PipelineValue from "@/components/golbal/PipelineValue";
import SubaccountFunnelChart from "@/components/golbal/SubaccountFunnelChart";
type Props = {
  params: {
    subAccountId: string;
  };
     ...
     <div className="relative h-full">
        ...
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <PipelineValue subAccId={subAccountId} />
