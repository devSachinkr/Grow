'use client'
import { EditorElement, useEditor } from '@/app/providers/web-editor/editorProvider'
import Loading from '@/components/golbal/Loading'
import ToastNotify from '@/components/golbal/ToastNotify'
import { Badge } from '@/components/ui/badge'
import { EditorBtns } from '@/lib/constants'
import { getFunnelDetails ,getSubAccountDetails} from '@/lib/queries'
...
const Checkout = (props: Props) => {
  ...
  useEffect(() => {
    if (funnelId) {
      const fetchData = async () => {
        const funnelData = await getFunnelDetails(funnelId)
